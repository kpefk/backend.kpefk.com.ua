...
export class CreateScheduleEntryDto {
	...
	@IsOptional()
	@ValidateIf(
		(o: CreateScheduleEntryDto) => o.onlineUrl != null && o.onlineUrl !== ''
	)
	@IsUrl(
		{ require_tld: false },
		{ message: 'onlineUrl має бути валідним посиланням.' }
	)
	onlineUrl?: string | null
}
...
export class UpdateScheduleEntryDto {
	...
	@IsOptional()
	@ValidateIf(
		(o: UpdateScheduleEntryDto) => o.onlineUrl != null && o.onlineUrl !== ''
	)
	@IsUrl(
		{ require_tld: false },
		{ message: 'onlineUrl має бути валідним посиланням.' }
