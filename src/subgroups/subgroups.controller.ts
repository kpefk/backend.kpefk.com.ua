...
export class SubgroupsController {
	...
	@ApiOperation({
		summary: 'Дисципліни групи, що діляться на підгрупи (з лічильниками)'
	})
	@Get()
	...
	@ApiOperation({
		summary: 'Поточний поділ дисципліни (студенти × підгрупа)'
	})
	@Get(':componentTermId')
	@HttpCode(HttpStatus.OK)
	public getSplit(
	...
	@ApiOperation({
		summary: 'Авто-поділ за списком (рівномірно на N підгруп)'
	})
