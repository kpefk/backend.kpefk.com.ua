...
export class AttendanceController {
	...
	public listLessons(
		...
		return this.attendanceService.listLessons(
			query,
	...
	public updateSession(
		...
		return this.attendanceService.updateSession(
			id,
			dto,
			this.actor(userId, role)
		)
	...
	@ApiOperation({
		summary: 'Перенести відвідуваність із попереднього заняття групи'
	})
	...
	@ApiOperation({
		summary: 'Зведена відвідуваності по дисципліні за семестр'
	})
	@Get('summary')
	@HttpCode(HttpStatus.OK)
	...
	@ApiOperation({
		summary:
			'Зведена відвідуваності студента за семестр (студент — лише власну)'
	})
