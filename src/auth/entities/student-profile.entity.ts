...
export class StudentDataEntity {
	...
	@ApiProperty({
		description: 'Форма навчання (денна/заочна/...)',
		example: 'Денна',
		nullable: true
	})
	@Expose()
	...
	@ApiProperty({
		description: 'Спеціалізація / Освітня програма',
		example: "Комп'ютерна інженерія",
		nullable: true
	})
	@Expose()
