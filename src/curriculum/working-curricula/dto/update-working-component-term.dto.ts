...
export class UpdateWorkingComponentTermDto {
	...
	@ApiPropertyOptional({
		description: 'Самостійна робота (години)',
		default: 0
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		description: 'Тижневе навантаження (лекції)',
		example: 2.0
	})
	@IsOptional()
	@IsNumber()
	...
	@ApiPropertyOptional({
		description: 'Тижневе навантаження (практика)',
		example: 2.0
	})
	@IsOptional()
	@IsNumber()
	...
	@ApiPropertyOptional({
		description:
			'UUID викладача, відповідального за цей компонент у цьому семестрі. null — зняти призначення.',
	...
	@ApiPropertyOptional({
		description:
			'Кількість контрольних робіт під час аудиторних занять (п.11)',
		default: 0
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		description:
			'Кількість контрольних робіт під час самостійної роботи (п.12)',
		default: 0
	})
	@IsOptional()
	@IsInt()
