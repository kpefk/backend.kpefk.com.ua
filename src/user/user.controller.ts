...
export class UserController {
	...
	@ApiResponse({
		status: 401,
		description: 'Невірний поточний пароль або не авторизований'
	})
	@Authorization()
	@HttpCode(HttpStatus.OK)
	...
	@ApiResponse({
		status: 200,
		description: 'Лист підтвердження надіслано на нову адресу'
	})
	@ApiResponse({
		status: 401,
		description: 'Невірний пароль або не авторизований'
	})
	...
	@ApiResponse({
		status: 200,
		description:
			'Пароль успішно скинуто, тимчасовий пароль надіслано на email',
		type: UserEntity
	})
	@ApiResponse({ status: 401, description: 'Не авторизований' })
	@ApiResponse({ status: 403, description: 'Доступ заборонено' })
