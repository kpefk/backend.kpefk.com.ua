...
export class PersonEducationsListForExternalItemDto {
	...
	@ApiProperty({
		description: 'Код картки фізичної особи в ЄДЕБО',
		example: 123
	})
	personId!: number
	...
	@ApiPropertyOptional({
		description: 'Країна громадянства (Id)',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Країна громадянства (Назва)',
		example: 'Україна',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Освітній ступінь (Id)',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Освітній ступінь (Назва)',
		example: 'Бакалавр',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Форма навчання (Назва)',
		example: 'Денна',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Джерело фінансування (Id)',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Назва спеціалізації',
		example: 'Веб-розробка',
		nullable: true
	})
	specializationName!: string | null

	@ApiPropertyOptional({
		description: 'Освітня програма (Id)',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Освітня програма (Назва)',
		example: "Комп'ютерні науки",
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Код класифікатора професії 1',
		example: '2131',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Код класифікатора професії 2',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Код класифікатора професії 3',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Код класифікатора професії 4',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Код класифікатора професії 5',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Поточний курс навчання',
		example: '2',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Вступ на основі (Id)',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Тип документу про освіту (Id)',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Серія документу про освіту',
		example: 'АА',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Номер документу про освіту',
		example: '123456',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Початок навчання (наказ)',
		example: 'Наказ №123 від 01.09.2022',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Закінчення навчання (наказ)',
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Причина відрахування (Id)',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Статус навчання (Id)',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Статус навчання (Назва)',
		example: 'Навчається',
		nullable: true
	})
