...
export class StudentEducationHistoryDeletedListItemDto {
	...
	@ApiProperty({
		description: 'Назва статусу навчання',
		example: 'Навчається'
	})
	...
	@ApiPropertyOptional({
		description: 'Код форми навчання',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Назва форми навчання',
		example: 'Денна',
		nullable: true
	})
	...
	@ApiProperty({
		description: 'Чи здобуває освітній ступінь за дуальною формою навчання',
		example: false
	})
	isDualForm!: boolean
	...
	@ApiPropertyOptional({
		description: 'Назва освітнього ступеня',
		example: 'Бакалавр',
		nullable: true
	})
	...
	@ApiProperty({
		description: 'ПІБ користувача, що вніс запис',
	...
	@ApiProperty({
		description: 'ПІБ користувача, що вніс зміни',
		example: 'Петренко Петро Петрович'
	})
	...
	@ApiPropertyOptional({
		description: 'Редакція спеціальності',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Код спеціалізації закладу освіти',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Код освітньої програми',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Назва освітньої програми',
	...
	@ApiPropertyOptional({
		description: 'Назва причини відрахування',
	...
	@ApiPropertyOptional({
		description: 'Код підстави надання академічної відпустки',
		example: 1,
		nullable: true
	})
	...
	@ApiPropertyOptional({
		description: 'Зведена інформація щодо всіх професій',
		nullable: true
	})
