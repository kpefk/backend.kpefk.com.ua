...
export class StudentEducationHistoryAddDto {
	...
	@ApiPropertyOptional({
		description: 'Ідентифікатор професії №1',
		example: 1
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		description: 'Ідентифікатор професії №2',
		example: 1
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		description: 'Ідентифікатор професії №3',
		example: 1
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		description: 'Ідентифікатор професії №4',
		example: 1
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		description: 'Ідентифікатор професії №5',
		example: 1
	})
	@IsOptional()
	@IsInt()
