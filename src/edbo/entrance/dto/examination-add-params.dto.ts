...
export class ExaminationAddParamsDto {
	...
	@ApiPropertyOptional({
		description: 'Голова комісії (ПІБ)',
	...
	@ApiPropertyOptional({
		description: 'Адреса комісії',
		example: 'м. Київ, пр. Перемоги, 37'
	})
	@IsOptional()
	@IsString()
	adress?: string
	...
	@ApiPropertyOptional({
		description: 'Email',
		example: 'admission@university.edu.ua'
	})
	@IsOptional()
	@IsString()
	email?: string
	...
	@ApiPropertyOptional({
		...
		example: 'https://university.edu.ua'
	})
	@IsOptional()
	@IsString()
	webSite?: string
	...
	@ApiPropertyOptional({
		description: 'Код факультету (структурного підрозділу)',
		example: 1
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		description: 'Контактний номер голови комісії',
