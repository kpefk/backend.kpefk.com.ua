...
export class PersonRequestSubjectResultUpdateParamsDto {
	...
	@ApiProperty({
		...
		description:
			'Масив результатів випробувань та конкурсних показників. УВАГА! Відсутність випробування трактується як його видалення'
	})
	@IsArray()
	...
	@ApiPropertyOptional({
		description:
			'Чи підтверджено зміну результатів випробувань у іншій заяві вступника'
	})
	@IsBoolean()
	@IsOptional()
