...
export class UniversityExamListResponseDto {
	...
	@ApiPropertyOptional({
		description: 'ID предмету вступного випробування (з довідника)'
	})
	subjectId?: number | null

	@ApiPropertyOptional({
		description: 'Предмет вступного випробування (з довідника)'
	})
	subjectNameFromDict?: string | null

	@ApiPropertyOptional({
		description: 'Назва вступного випробування (не з довідника)'
	})
	subjectName?: string | null

	@ApiPropertyOptional({
		description: 'Назва вступного випробування (результуюча)'
	})
	subjectNameFull?: string | null

	@ApiPropertyOptional({
		description: 'ID спеціальності (для творчих конкурсів)'
	})
	specialityId?: number | null

	@ApiPropertyOptional({
		description: 'Повна назва спеціальності (для творчих конкурсів)'
	})
	specialityFullName?: string | null

	@ApiPropertyOptional({
		description: 'ID спеціалізації (для творчих конкурсів)'
	})
	specializationId?: number | null

	@ApiPropertyOptional({
		description: 'Повна назва спеціалізації (для творчих конкурсів)'
	})
	specializationFullName?: string | null

	@ApiPropertyOptional({
		description: 'Чи відображається запис в електронному кабінеті'
	})
