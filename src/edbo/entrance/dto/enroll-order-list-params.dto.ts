...
export class EnrollOrderListParamsDto {
	...
	@ApiPropertyOptional({
		description: 'ID запису наказу (фільтр)',
		example: 1
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		description: 'Номер наказу (фільтр)',
		example: '123-з'
	})
	@IsOptional()
	@IsString()
	...
	@ApiPropertyOptional({
		description: 'Номер протоколу (фільтр)',
		example: 'П-15'
	})
	@IsOptional()
	@IsString()
	...
	@ApiPropertyOptional({
		description: 'ID джерела фінансування (фільтр)',
		example: 1
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		description: 'ID форми навчання (фільтр)',
		example: 1
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		description: 'ID рівня освіти (фільтр)',
		example: 1
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		description: 'ID вступу на основі (фільтр)',
		example: 1
	})
	@IsOptional()
	@IsInt()
	...
	@ApiPropertyOptional({
		...
		example: 'orderOfEnrollmentDate DESC'
	})
	@IsOptional()
	@IsString()
	sortField?: string
