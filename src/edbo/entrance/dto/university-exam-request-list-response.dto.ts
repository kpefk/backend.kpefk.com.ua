...
export class UniversityExamRequestListResponseDto {
	...
	@ApiPropertyOptional({
		description:
			'Контактні телефони, вказані вступником у електронному кабінеті'
	})
	personPhone?: string | null

	@ApiPropertyOptional({
		description: 'E-mail, вказаний вступником у електронному кабінеті'
	})
	...
	@ApiPropertyOptional({
		description: 'ID статусу заяви на участь у випробуванні'
	})
	examRequestStatusId?: number | null

	@ApiPropertyOptional({
		description: 'Статус заяви на участь у випробуванні'
	})
	...
	@ApiPropertyOptional({
		description: 'Дата та час проведення випробування (обраний потік)'
	})
	universityExamDate?: Date | null

	@ApiPropertyOptional({
		description: 'Місце проведення випробування (обраний потік)'
	})
	universityExamVenue?: string | null

	@ApiPropertyOptional({
		description: 'Чи подано з електронного кабінету вступника'
	})
	isEz?: boolean | null
