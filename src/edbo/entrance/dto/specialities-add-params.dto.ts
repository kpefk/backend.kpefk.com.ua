...
export class SpecialitiesAddParamsDto {
	...
	@ApiPropertyOptional({
		description: 'Здобуття ступеня за іншою спеціальністю'
	})
	@IsBoolean()
	@IsOptional()
	...
	@ApiPropertyOptional({
		description: 'Чи використовувати приорітетність заяв'
	})
	@IsBoolean()
	@IsOptional()
	...
	@ApiPropertyOptional({
		description: 'Тип освітньої програми (для програми магістра)'
	})
	@IsInt()
	@IsOptional()
	...
	@ApiPropertyOptional({
		description: 'Регіонального замовлення від (орган управління)'
	})
	@IsInt()
	@IsOptional()
	...
	@ApiPropertyOptional({
		description: 'Чи розрахувати вартість за повний термін автоматично'
	})
	@IsBoolean()
	@IsOptional()
	...
	@ApiPropertyOptional({
		description:
			'Чи КП для перезарахування кредитів ЄКТС (для вступу на основі МС, ФМБ, МБ)'
	})
	@IsBoolean()
	@IsOptional()
