...
export class EntranceService {
	 ...
	 */
	cancellationList(
		params: CancellationListParamsDto
	): Promise<CancellationListResponseDto> {
	 ...
	 */
	async cancellationAdd(
		params: CancellationAddParamsDto
	): Promise<CancellationAddResponseDto> {
		const id = await this.edbo.post<number>(
	 ...
	 */
	enrollOrderList(
		params: EnrollOrderListParamsDto
	): Promise<EnrollOrderListResponseDto> {
	 ...
	 */
	enrollOrderGet(
		params: EnrollOrderGetParamsDto
	): Promise<EnrollOrderGetResponseDto> {
	 ...
	 */
	examinationCheck(
		params: ExaminationCheckParamsDto
	): Promise<ExaminationCheckResponseDto> {
	 ...
	 */
	personRequestChangeStatus(
		params: PersonRequestChangeStatusParamsDto
	): Promise<boolean> {
		return this.edbo.post(
	 ...
	 * @returns `true` у разі успішного оновлення
	 */
	personRequestComplexUpdate(
		params: PersonRequestComplexUpdateParamsDto
	): Promise<boolean> {
		return this.edbo.post(
	 ...
	 */
	personRequestUpdate(
		params: PersonRequestUpdateParamsDto
	): Promise<boolean> {
	 ...
	 */
	programSpecialityAdd(
		params: ProgramSpecialityAddParamsDto
	): Promise<boolean> {
	 ...
	 * @returns `true` у разі успішного видалення
	 */
	programSpecialityDel(
		params: ProgramSpecialityDelParamsDto
	): Promise<boolean> {
	 ...
	 */
	specialitiesList(
		params: SpecialitiesListParamsDto
	): Promise<SpecialitiesListResponseDto[]> {
	 ...
	 */
	entrySubjectList(
		params: EntrySubjectListParamsDto
	): Promise<EntrySubjectListResponseDto[]> {
		return this.edbo.post(
	 ...
	 * @returns `true` у разі успішного видалення
	 */
	universityExamDelete(
		params: UniversityExamDeleteParamsDto
	): Promise<boolean> {
	 ...
	 * @returns `true` у разі успішного створення
	 */
	universityExamRequestAdd(
		params: UniversityExamRequestAddParamsDto
	): Promise<boolean> {
		return this.edbo.post(
	 ...
	 */
	universityExamRequestPhoto(
		params: UniversityExamRequestPhotoParamsDto
	): Promise<boolean> {
		return this.edbo.post(
			'/api/entrance/universityExams/requests/photo',
			params
		)
	}
	 ...
	 * @returns `true` у разі успішного додавання
	 */
	universityExamSpecAdd(
		params: UniversityExamSpecAddParamsDto
	): Promise<boolean> {
	 ...
	 * @returns `true` у разі успішного видалення
	 */
	universityExamSpecDelete(
		params: UniversityExamSpecDeleteParamsDto
	): Promise<boolean> {
		return this.edbo.post(
	 ...
	 * @returns `true` у разі успішного створення
	 */
	universityExamStreamAdd(
		params: UniversityExamStreamAddParamsDto
	): Promise<boolean> {
		return this.edbo.post(
	 ...
	 * @returns `true` у разі успішного видалення
	 */
	universityExamStreamDelete(
		params: UniversityExamStreamDeleteParamsDto
	): Promise<boolean> {
		return this.edbo.post(
	 ...
	 * @returns `true` у разі успішного оновлення
	 */
	universityExamStreamEdit(
		params: UniversityExamStreamEditParamsDto
	): Promise<boolean> {
		return this.edbo.post(
