...
export class ListenersListExternalResponseDto {
	...
	@ApiProperty({
		...
		example: '1991-08-24T17:36:25+03:00'
	})
	@Expose()
	@Type(() => String)
	birthday!: string
	 ...
	 */
	@ApiProperty({
		description: 'Документ, що посвідчує особу — тип (Id)',
		example: 1
	})
	@Expose()
	@Type(() => Number)
	 ...
	 */
	@ApiProperty({
		description: 'Документ, що посвідчує особу — тип (назва)',
	 ...
	 */
	@ApiProperty({
		description: 'Документ, що посвідчує особу — серія',
		example: 'АА'
	})
	@Expose()
	@Type(() => String)
	 ...
	 */
	@ApiProperty({
		description: 'Документ, що посвідчує особу — номер',
		example: '123456'
	})
	@Expose()
	@Type(() => String)
	 ...
	 */
	@ApiProperty({
		description: 'Документ, що посвідчує особу — дата видачі',
		example: '1991-08-24T17:36:25+03:00'
	})
	@Expose()
	@Type(() => String)
	 ...
	 */
	@ApiProperty({
		description: 'Документ, що посвідчує особу — термін дії',
		example: '2031-08-24T17:36:25+03:00'
	})
	@Expose()
	@Type(() => String)
	 ...
	 */
	@ApiProperty({
		description: 'Початок навчання (наказ / підстава)',
		example: 'Наказ №123 від 01.09.2021'
	})
	@Expose()
	@Type(() => String)
	reason!: string
	...
	@ApiProperty({
		...
		example: '1993-06-30T00:00:00+03:00'
	})
	@Expose()
	@Type(() => String)
	 ...
	 */
	@ApiProperty({
		description: 'Дата створення картки слухача',
		example: '1991-08-24T17:36:25+03:00'
	})
	@Expose()
	@Type(() => String)
	 ...
	 */
	@ApiProperty({
		description: 'Дата останнього редагування картки слухача',
		example: '1991-08-24T17:36:25+03:00'
	})
	@Expose()
	@Type(() => String)
