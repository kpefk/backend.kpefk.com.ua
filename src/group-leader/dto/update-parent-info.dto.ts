...
export class UpdateParentInfoDto {
	...
	@IsString()
	@Matches(UA_PHONE, {
		message: 'motherPhone: формат +380XXXXXXXXX або 0XXXXXXXXX'
	})
	motherPhone?: string
	...
	@IsString()
	@Matches(UA_PHONE, {
		message: 'fatherPhone: формат +380XXXXXXXXX або 0XXXXXXXXX'
	})
	fatherPhone?: string
	...
	@IsString()
	@Matches(UA_PHONE, {
		message: 'guardianPhone: формат +380XXXXXXXXX або 0XXXXXXXXX'
	})
	...
	@ApiPropertyOptional({
		description: 'Приватні нотатки керівника (не видно студенту)'
	})
	@IsOptional()
	@IsString()
	@MaxLength(2000)
