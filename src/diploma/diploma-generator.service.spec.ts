	...
	return {
		...
		components: [
			mkComp(
				...
				'History of statehood and culture',
				3,
				'REGULAR',
				'SATISFACTORY',
				'EXAM'
			...
			mkComp(
				...
				'Qualification work (diploma project)',
				9,
				'ATTESTATION',
				'EXCELLENT',
				'EXAM'
...
describe('DiplomaGeneratorService — повнота заповнення', () => {
	...
	describe('Диплом', () => {
		...
		it('у згенерованому .docx немає залишків {...}', async () => {
			const { buffer, filename } = await service.generateOne(
				'd1',
				'diploma'
			)
	...
	describe('Додаток', () => {
		...
		it('містить персональні дані, §6.2.2, §7.1 та зведену відомість', async () => {
			...
			for (const v of [
				'Шевченко',
				'Тарас',
				'13/06/2007', // ПІБ + дата народження §1.3
				'10138693', // §1.4 код картки фіз. особи
				'X26',
				'051136',
				'1960044', // серія/№ + реєстр. № додатка
				...
				'001501',
				'136',
				'09/06/2019', // §6.2.3 акредитація
				'Ірина Вахович',
				'Iryna Vakhovych', // §7.3.1 підпис
